...
public class MinusData {
	...
	public MinusData(Object object) {
		if(object != null && object instanceof MinusData) {
			MinusData other = ((MinusData) object);
			this.computed_left = other.computed_left;
			this.computed_right = other.computed_right;
		} else if(object != null && object instanceof Minus) {
			Minus node = ((Minus) object);
		}
	}
