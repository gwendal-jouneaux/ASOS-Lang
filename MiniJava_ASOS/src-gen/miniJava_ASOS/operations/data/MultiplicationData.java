...
public class MultiplicationData {
	...
	public MultiplicationData(Object object) {
		if(object != null && object instanceof MultiplicationData) {
			MultiplicationData other = ((MultiplicationData) object);
			this.computed_left = other.computed_left;
			this.computed_right = other.computed_right;
		} else if(object != null && object instanceof Multiplication) {
			Multiplication node = ((Multiplication) object);
		}
	}
