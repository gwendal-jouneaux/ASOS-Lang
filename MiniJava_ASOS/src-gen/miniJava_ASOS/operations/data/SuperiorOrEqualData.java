...
public class SuperiorOrEqualData {
	...
	public SuperiorOrEqualData(Object object) {
		if(object != null && object instanceof SuperiorOrEqualData) {
			SuperiorOrEqualData other = ((SuperiorOrEqualData) object);
			this.computed_left = other.computed_left;
			this.computed_right = other.computed_right;
		} else if(object != null && object instanceof SuperiorOrEqual) {
			SuperiorOrEqual node = ((SuperiorOrEqual) object);
		}
	}
	
	public SuperiorOrEqualData() {}
}
