...
public class InferiorData {
	...
	public InferiorData(Object object) {
		if(object != null && object instanceof InferiorData) {
			InferiorData other = ((InferiorData) object);
			this.computed_left = other.computed_left;
			this.computed_right = other.computed_right;
		} else if(object != null && object instanceof Inferior) {
			Inferior node = ((Inferior) object);
		}
	}
