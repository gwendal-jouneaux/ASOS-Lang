...
public class DivisionData {
	...
	public DivisionData(Object object) {
		if(object != null && object instanceof DivisionData) {
			DivisionData other = ((DivisionData) object);
			this.computed_left = other.computed_left;
			this.computed_right = other.computed_right;
		} else if(object != null && object instanceof Division) {
			Division node = ((Division) object);
		}
	}
