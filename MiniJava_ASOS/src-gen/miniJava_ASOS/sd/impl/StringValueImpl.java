 ...
 * </p>
 * <ul>
 *   <li>{@link miniJava_ASOS.sd.impl.StringValueImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StringValueImpl extends ValueImpl implements StringValue {
	...
	protected EClass eStaticClass() {
		return SdPackage.Literals.STRING_VALUE;
	}
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SdPackage.STRING_VALUE__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case SdPackage.STRING_VALUE__VALUE:
			return getValue();
		}
