 ...
 * </p>
 * <ul>
 *   <li>{@link miniJava_ASOS.sd.impl.BooleanValueImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BooleanValueImpl extends ValueImpl implements BooleanValue {
	...
	protected EClass eStaticClass() {
		return SdPackage.Literals.BOOLEAN_VALUE;
	}
	...
	public void setValue(Boolean newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SdPackage.BOOLEAN_VALUE__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case SdPackage.BOOLEAN_VALUE__VALUE:
			return getValue();
		}
