 ...
 * </p>
 * <ul>
 *   <li>{@link miniJava_ASOS.sd.impl.SymbolBindingImpl#getValue <em>Value</em>}</li>
 *   <li>{@link miniJava_ASOS.sd.impl.SymbolBindingImpl#getSymbol <em>Symbol</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SymbolBindingImpl extends MinimalEObjectImpl.Container implements SymbolBinding {
	...
	protected EClass eStaticClass() {
		return SdPackage.Literals.SYMBOL_BINDING;
	}
	...
	public NotificationChain basicSetValue(Value newValue, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					SdPackage.SYMBOL_BINDING__VALUE, oldValue, newValue);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newValue != value) {
			...
			if (value != null)
				msgs = ((InternalEObject) value).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - SdPackage.SYMBOL_BINDING__VALUE, null, msgs);
			if (newValue != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, SdPackage.SYMBOL_BINDING__VALUE, newValue, newValue));
	}
	...
	public Symbol getSymbol() {
		if (symbol != null && symbol.eIsProxy()) {
			...
			if (symbol != oldSymbol) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SdPackage.SYMBOL_BINDING__SYMBOL,
							oldSymbol, symbol));
			}
		}
		return symbol;
	...
	public void setSymbol(Symbol newSymbol) {
		...
		symbol = newSymbol;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SdPackage.SYMBOL_BINDING__SYMBOL, oldSymbol, symbol));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case SdPackage.SYMBOL_BINDING__VALUE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case SdPackage.SYMBOL_BINDING__VALUE:
			return getValue();
		case SdPackage.SYMBOL_BINDING__SYMBOL:
			if (resolve)
				return getSymbol();
