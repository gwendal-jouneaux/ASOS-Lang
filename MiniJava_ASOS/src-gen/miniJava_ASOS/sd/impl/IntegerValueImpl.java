 ...
 * </p>
 * <ul>
 *   <li>{@link miniJava_ASOS.sd.impl.IntegerValueImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IntegerValueImpl extends ValueImpl implements IntegerValue {
	...
	protected EClass eStaticClass() {
		return SdPackage.Literals.INTEGER_VALUE;
	}
	...
	public void setValue(Integer newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SdPackage.INTEGER_VALUE__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case SdPackage.INTEGER_VALUE__VALUE:
			return getValue();
		}
