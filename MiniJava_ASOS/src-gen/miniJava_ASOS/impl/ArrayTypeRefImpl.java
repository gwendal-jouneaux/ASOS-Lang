 ...
 * </p>
 * <ul>
 *   <li>{@link miniJava_ASOS.impl.ArrayTypeRefImpl#getTypeRef <em>Type Ref</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ArrayTypeRefImpl extends MinimalEObjectImpl.Container implements ArrayTypeRef {
	...
	protected EClass eStaticClass() {
		return MiniJava_ASOSPackage.Literals.ARRAY_TYPE_REF;
	}
	...
	public NotificationChain basicSetTypeRef(SingleTypeRef newTypeRef, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					MiniJava_ASOSPackage.ARRAY_TYPE_REF__TYPE_REF, oldTypeRef, newTypeRef);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newTypeRef != typeRef) {
			...
			if (typeRef != null)
				msgs = ((InternalEObject) typeRef).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - MiniJava_ASOSPackage.ARRAY_TYPE_REF__TYPE_REF, null, msgs);
			if (newTypeRef != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, MiniJava_ASOSPackage.ARRAY_TYPE_REF__TYPE_REF,
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case MiniJava_ASOSPackage.ARRAY_TYPE_REF__TYPE_REF:
