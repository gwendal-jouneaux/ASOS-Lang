...
public class MiniJava_ASOSFeedbackLoop extends FeedbackLoop<SelfAdaptiveMiniJava_ASOS, MiniJava_ASOSAdaptationContext> {
	private static long time = 0;
	Map<String, Double> userConfig;
	Map<Resource, Double> resourcesValues;
	ImpactEvaluationVisitor vis;

	protected MiniJava_ASOSFeedbackLoop(MiniJava_ASOSAdaptationContext adaptationCtx) {
		super(adaptationCtx);
