package fr.gjouneau.HTML.parser;

import java.util.ArrayList;
import java.util.Arrays;
import java.util.List;

import fr.gjouneau.HTML.nodes.HTMLNodeAttribute;
import fr.gjouneau.HTML.nodes.HTMLNodeBase;
import fr.gjouneau.HTML.nodes.HTMLNodeBaseTag;
import fr.gjouneau.HTML.nodes.HTMLNodeBlockTag;
import fr.gjouneau.HTML.nodes.HTMLNodeEmptyTag;
import fr.gjouneau.HTML.nodes.HTMLNodePlainText;
...
public class HTMLParser {
	...
	public HTMLNodeRoot parse() {
		...
		HTMLNodeRoot out = new HTMLNodeRoot(htmlBlock);
		return out;
	}
	...
	private HTMLNodeBlockTag parseBlock(int startindex, int endIndex, int blockEnd, String stringTag) {
		...
		HTMLNodeBlockTag out = new HTMLNodeBlockTag(stringTag, attributes, children);
		return out;
	}
	...
	private HTMLNodeEmptyTag parseEmpty(int startindex, int endIndex, String stringTag) {
		...
		index += padding;
		HTMLNodeEmptyTag out = new HTMLNodeEmptyTag(stringTag, attributes);
		return out;
	}
	...
	private HTMLNodePlainText parseText(int endIndex) {
		...
		HTMLNodePlainText res = new HTMLNodePlainText(out.toString());
		return res;
	}
	...
	private HTMLNodeAttribute parseAttribute(int endIndex) {
		...
		if(content.charAt(index)=='=') {
			...
			HTMLNodeAttribute res = new HTMLNodeAttribute(name, value, type);
			return res;
		}
		HTMLNodeAttribute res = new HTMLNodeAttribute(name,null,null);
		return res;
	}
